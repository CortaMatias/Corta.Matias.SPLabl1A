...
/** \brief Filtra los elementos de la LinkedList
 * \param pList LinkedList* Puntero a la lista
 * \param void* puntero a la funcion filtrante
 * \return LinkedList* linkedlist nuevo con los elementos filtrados o NULL en caso de error
 */
